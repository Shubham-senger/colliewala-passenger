  ...
  return (
    <>
      <div className="w-full max-w-[430px] h-auto sm:h-[700px] p-8 sm:p-[60px_35px_35px_35px] rounded-[40px] bg-[#ecf0f3] shadow-[13px_13px_20px_#cbced1,-13px_-13px_20px_#ffffff] mx-auto my-4 sm:my-0">
        ...
        <div className="text-center text-[28px] pt-[24px] tracking-[0.5px]">
          Porters Login
        </div>
        ...
        <Link to="/loginwithnumber">
          <button className="outline-none border-none cursor-pointer w-full h-[60px] rounded-[30px] text-[20px] font-bold text-white bg-[#EC1C24] shadow-[3px_3px_8px_#b1b1b1,-3px_-3px_8px_#ffffff] transition duration-500 hover:bg-[#7f1734] active:bg-[#92000A] mt-4">
            Login with number
          </button>
        </Link>
        <div className="pt-5 text-center">
          ...
          or{" "}
          <Link to="/register/1" className="text-[#aaa] text-[15px] no-underline">
            Sign up
          </Link>
        </div>
      </div>
